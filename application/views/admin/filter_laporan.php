<div class="main-content">
	...
	<div class="btn-group">
		<a class="btn btn-success" target="_blank" href="<?php echo base_url('admin/laporan/cetak_laporan_semua') ?>"><i class="fas fa-print"></i> <b>Cetak</b></a>
		<a class="btn btn-success" target="_blank" href="<?php echo base_url('admin/laporan/download_pdf_semua') ?>"><i class="fas fa-file"></i> <b>Download</b></a>
	</div>
