              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('auth/login') ?>">
                  <div class="form-group">
                    ...
                    <input id="username" value="<?php echo set_value('username') ?>" type="text" class="form-control" name="username" tabindex="1" autofocus>
                  ...
                  <div class="form-group"><center>
                    Tidak Punya Akun? <a href="<?php echo base_url('daftar') ?>">Buat Akun</a></center>
                  </div>
                </form>
